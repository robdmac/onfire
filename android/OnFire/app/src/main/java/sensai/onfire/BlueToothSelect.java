...
/**
 * Created by rob on 11/19/17.
 */

public class BlueToothSelect extends Activity implements PullToRefresh.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Intent i = new Intent(BlueToothSelect.this, OnFireActivity.class);
        ...
        not_found.setOnClickListener(new View.OnClickListener() {
            ...
            Intent i = new Intent(BlueToothSelect.this, BlueToothScan.class);
            startActivity(i);
            }
        });
        ...
        if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
            ...
            switch (state) {
                case BluetoothAdapter.STATE_OFF:
                    ...
                    Toast.makeText(BlueToothSelect.this, "Turn on bluetooth", Toast.LENGTH_LONG).show();
                    break;
