...
class TrackAdapter extends RecyclerView.Adapter<TrackAdapter.TrackHolder> {
    ...
    private final static String FilesDir = OnFireApplication.getInstance().getApplicationContext().getFilesDir().toString() + "/Thumbnails/";
    ...
    private static final Bitmap[] bmpTrackType = {
            BitmapFactory.decodeResource(OnFireApplication.getInstance().getResources(), R.mipmap.ic_place_white_24dp),
            BitmapFactory.decodeResource(OnFireApplication.getInstance().getResources(), R.mipmap.ic_directions_walk_white_24dp),
            BitmapFactory.decodeResource(OnFireApplication.getInstance().getResources(), R.mipmap.ic_terrain_white_24dp),
            BitmapFactory.decodeResource(OnFireApplication.getInstance().getResources(), R.mipmap.ic_directions_run_white_24dp),
            BitmapFactory.decodeResource(OnFireApplication.getInstance().getResources(), R.mipmap.ic_directions_bike_white_24dp),
            BitmapFactory.decodeResource(OnFireApplication.getInstance().getResources(), R.mipmap.ic_directions_car_white_24dp),
            BitmapFactory.decodeResource(OnFireApplication.getInstance().getResources(), R.mipmap.ic_flight_white_24dp)
    };
    ...
    static class TrackHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void UpdateTrackStats(Track trk) {
            ...
            if (trk.getNumberOfLocations() > 1) {
                ...
                phd = phdformatter.format(trk.getEstimatedAltitudeGap(OnFireApplication.getInstance().getPrefEGM96AltitudeCorrection()),PhysicalDataFormatter.FORMAT_ALTITUDE);
        ...
        void BindTrack(Track trk) {
            ...
            bmp = OnFireApplication.thumbsArray.get((int) id);
    ...
    public int getItemViewType (int position) {
        return (position == 0) && OnFireApplication.getInstance().isCurrentTrackVisible() ? CARDTYPE_CURRENTTRACK : CARDTYPE_TRACK;
    }
